      ...
      child: SizedBox(
        ...
        child: Stack(
          children: [
              ...
              child: orientation == LShapeOrientation.leftLegOnLeft ? Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(type == 'Income' ? 'Top Earning' : 'Top Spending',
                    style: AppTextStyles.poppins12w300White(context)?.copyWith(
                      color: type == 'Income' ? HexColor('#49ABF2') : HexColor('#FF0000'),
                      fontSize: 14.sp,
                    ),
                  ),
                  ...
                  ...categories.asMap().entries.take(2).map((entry) {
                    ...
                    return Column(
                      crossAxisAlignment: orientation == LShapeOrientation.leftLegOnLeft 
                        ? CrossAxisAlignment.start 
                        : CrossAxisAlignment.end,
                      children: [
                        Text('${category.name} - ${category.percentage.toStringAsFixed(0)}%',
                          style: AppTextStyles.poppins12w300White(context)?.copyWith(
                            color: Colors.black,
                            fontSize: 14.sp,
                          ),
                        ...
                        SizedBox(
                          ...
                          child: LinearProgressIndicator(
                            value: totalAmount > 0 ? (category.amount / totalAmount) : 0,
                            backgroundColor: Colors.grey[300],
                            valueColor: AlwaysStoppedAnimation<Color>(
                              type == 'Income' ? HexColor('#49ABF2') : HexColor('#FF0000')
                            ),
                          ),
                        ),
              ...
              Positioned(
                bottom: -24.sp,
                left: orientation == LShapeOrientation.leftLegOnLeft ? 3.5.w : 16.w,
                right: 0,
                ...
                child: Row(
                 mainAxisAlignment: MainAxisAlignment.start,
                  children:  [
                    ...
                    SizedBox(width: orientation == LShapeOrientation.leftLegOnLeft ? 14.w : 11.w,),
                     Container(
                      
                               
                                decoration: BoxDecoration(
                                  
                                    color: orientation == LShapeOrientation.leftLegOnLeft ? HexColor('#42887C') : HexColor('#FF0000'),
